...
//                window.console.log(window.history.pushState());
    ...
    <div>
        ...
        <div class='ui left fixed vertical labeled tiny icon menu' style='width: 70px'>
            ...
            <a id="CSE" href="branches/CSE/" class='item' style="width: 50px" title="Computer Science & engineering">
        ...
        <div style="margin-top: 50px">
            <div class='ui very segment'><br/><br/>
                <div style="width: 350px;margin-left: 150px;float: left;margin-top: 50px">
                  ...
                  <image src='./images/mainlogo.png' class='ui medium image' style='margin-left:250px;display: inline-block;margin-top: 38px;' id="logo"/>
   ...
   <div class="ui card" id="aboutcard" style="display: none;width: 700px;height: 450px;position: fixed;background-color: #f2f2f2;top:80px;left:290px;border-radius: 10px">
    ...
    <div id="forgotpswcard" class="ui card" style="display: none;width: 290px;height: 250px;position: fixed;top:139px;left:214px;border-radius: 5px">
            <div class="content">
        ...
        <div class="extra content">
            <center>password visible for 10 seconds only</center>
        </div>
    </div>
    </body>
</html>
