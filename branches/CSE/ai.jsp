    ...
    <body>
        <div style="margin-left: 150px;margin-top: 90px">
            <div class='ui top fixed labeled mini icon menu' style="height:60px">
                ...
                <p style='margin-left:40px;margin-top:10px;font-size:25px;font-family:san-serif;'>Artificial Intelligence</p>
                            ...
                            try{  
                                ...
                                if(rs.next()){  
                                    ...
                                    while(rs.next()){
                                        ...
                                        rs1.next();
                                        out.print("<div class='content' style='max-height:auto' ><div class='header'><a>"+rs.getString(2)+"</a><div class='ui label' style='float: right'><a href='./'>CSE</a></div><div class='ui label' style='float: right'><a href='./ai.jsp'>AI</a></div></div>");
          ...
          <!--  <div class="ui card" style="position: relative;top:-1230px;left:680px;width:320px;max-height: 200px; overflow-y: scroll">
            <%    
                try{  
                    Class.forName("com.mysql.jdbc.Driver");  
                    Connection con=DriverManager.getConnection(  
                    ...
                    ResultSet rs = stmt.executeQuery();
                    while(rs.next()){
                        out.print("<div class='content'><a href='#"+rs.getString(1)+"'>"+rs.getString(2)+"</a></div>");
                    }
                 }
                catch(Exception e){
                      out.print(e);
