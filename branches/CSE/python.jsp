    ...
    <body>
        <div style="margin-left: 150px;margin-top: 90px">
            <div class='ui top fixed labeled mini icon menu' style="height:60px">
                ...
                <p style='margin-left:40px;margin-top:10px;font-size:25px;font-family:san-serif;'>Python programming</p>
                            ...
                            try{  
                                ...
                                if(rs.next()){  
                                    ...
                                    while(rs.next()){
                                        ...
                                        rs1.next();
                                        out.print("<div class='content' style='max-height:auto' ><div class='header'><a id="+rs.getString(2)+">"+rs.getString(2)+"</a><div class='ui label' style='float: right'><a href='./'>CSE</a></div><div class='ui label' style='float: right'><a href='./python.jsp'>Python</a></div></div>");
